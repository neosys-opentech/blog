...
+ Apprendre de la production pour affiner le backlog produit ou arrêter carrément d'y investir si ce n'est pas opportun : c'est la vie, le comportement des consommateurs n'est jamais prévisible et c'est toujours mieux d'échouer vite que d'inestir 1 ans dans un projet avec 0 bénéfices à la fin.

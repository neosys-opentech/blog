...
front_image: /assets/images/posts/linkerd-post-image.png
---
...
{:.ns-post-img-fluid}
![alt Architecture de Linkerd]({{ '/assets/images/posts/linkerd-architecture.png' | relative_url }})
...
{% gist 883d94dd427b7fa46700f262f45875e6 %}
...
{:.ns-post-img-fluid}
![alt Dashboard de Linkerd]({{ '/assets/images/posts/linkerd-dashboard.png' | relative_url }})
...
{:.ns-post-img-fluid}
![alt Graphe de dépendance]({{ '/assets/images/posts/linkerd-dependency-graph.png' | relative_url }})

{:.ns-post-img-fluid}
![alt liste des appels http]({{ '/assets/images/posts/linkerd-pod-calls.png' | relative_url }})
...
{% gist 28ba8751b11b10553f6bd32993ec40cc %}
...
{:.ns-post-img-fluid}
![Meshed tooltip]({{ '/assets/images/posts/linkerd-meshed-icon.png' | relative_url }})
...
{:.ns-post-img-fluid}
![Linkerd grafana dashboard]({{ '/assets/images/posts/linkerd-grafana.png' | relative_url }})

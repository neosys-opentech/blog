...
{:.ns-post-img-fluid}
![alt Architecture de Linkerd]({% link /assets/images/posts/linkerd-architecture.png %})
...
{:.ns-post-img-fluid}
![alt Dashboard de Linkerd]({% link /assets/images/posts/linkerd-dashboard.png %})
...
{:.ns-post-img-fluid}
![alt Graphe de dépendance]({% link /assets/images/posts/linkerd-dependency-graph.png %})

{:.ns-post-img-fluid}
![alt liste des appels http]({% link /assets/images/posts/linkerd-pod-calls.png %})
...
{:.ns-post-img-fluid}
![Meshed tooltip]({% link /assets/images/posts/linkerd-meshed-icon.png %})
...
{:.ns-post-img-fluid}
![Linkerd grafana dashboard]({% link /assets/images/posts/linkerd-grafana.png %})
